function(create_project_lib TARGET )
    # Для header-only библиотек не нужны исходные файлы
    # Создаем INTERFACE библиотеку
    add_library(${TARGET} INTERFACE)
    
    # Добавляем путь к заголовкам
    target_include_directories(${TARGET} INTERFACE ${CMAKE_CURRENT_SOURCE_DIR})
    
    # Сохраняем в глобальные свойства (как в оригинальной функции)
    ...
    set_property(GLOBAL PROPERTY LIBS_I_P ${LIB_I_LIST})
endfunction()
